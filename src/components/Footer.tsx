        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className={`mt-2 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              Building modern web applications with Python
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end">
            <div className="flex space-x-4 mb-4">
              <a 
                ...
                className={`text-gray-400 hover:${darkMode ? 'text-blue-400' : 'text-blue-600'}`}
                aria-label="LinkedIn"
              >
            ...
            <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              © {year} All rights reserved. Made with <Heart size={14} className="inline text-red-500" /> by Hamika Redrowthu
            </p>
          </div>
        </div>
      </div>
